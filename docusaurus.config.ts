...
const config: Config = {
  ...
  themeConfig: {
    ...
    announcementBar: {
      ...
      content: `🌟 Để biết thêm những khoá học đang có chương trình siêu đãi,mời bạn ấn <a href="https://kmin.edu.vn/" target="_blank" style={{ textDecoration: "underline" }}> VÀO ĐÂY</a>! 🌟`,
      isCloseable: false,
      textColor: "#FFFFFF",
    },
    navbar: {
